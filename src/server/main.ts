...
const runtime=new LocalRuntime({dataRoot,freePool,openRouterFree:freeConfig,directFree:directConfig,resourceBudget:{maxConcurrentTurns:store.policy.maxInference,maxProductiveTurns:store.policy.maxProductiveTurns??1,productiveArtifactIdentity:store.policy.productiveConcurrencyQualification?.artifactIdentity,...(store.policy.productiveConcurrencyQualification?.mode==='local-remote'?{productiveRemoteModelId:store.policy.productiveConcurrencyQualification.remoteModelId,productiveRemoteArtifactIdentity:store.policy.productiveConcurrencyQualification.remoteArtifactIdentity}:store.policy.productiveConcurrencyQualification?.mode==='local-remotes'?{productiveRemoteProfiles:store.policy.productiveConcurrencyQualification.remoteProfiles,productiveProviderCaps:store.policy.productiveConcurrencyQualification.providerCaps}:{}),maxSocialTurns:Math.max(1,store.policy.maxInference-1),maxLoadedModels:store.policy.maxInference>1?2:1}});const broker=new CorporateBroker(store,dataRoot);let workerHost='';
