  ...
  try{
   ...
   case 'company_detail':{
    ...
    if(args.view==='inspection'){
     ...
     result={record:{id:record.id},...metadata,...excerpt(JSON.stringify(records,null,2),Math.max(0,Number(args.offset)||0))};break;
    }
